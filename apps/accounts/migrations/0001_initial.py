    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_usuario', models.CharField(choices=[('admin', 'Administrador'), ('moderador', 'Moderador'), ('usuario', 'Usuário Comum')], default='usuario', max_length=15, verbose_name='Tipo de Usuário')),
