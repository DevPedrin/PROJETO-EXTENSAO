...
class Migration(migrations.Migration):
    """
    Migration inicial do model Denuncia.

    Cria a tabela portal_denuncia com FK para o model de usuário customizado
    (accounts.User). O campo `usuario` nunca é null — denúncias anônimas
    usam o usuário técnico criado na migration 0002.
    """
